...
public class DisplaySettings extends DashboardFragment implements OnPreferenceChangeListener {
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        ...
        try {
            mPitchPreference.setChecked(mOverlayManager.getOverlayInfo("com.custom.pitchblacksystem", UserHandle.USER_CURRENT).isEnabled());
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (preference == mPitchPreference) {
            setOverlay("com.custom.pitchblacksystem", (Boolean) newValue);
            setOverlay("com.custom.pitchblacksettings", (Boolean) newValue);
            setOverlay("com.custom.pitchblacksystemui", (Boolean) newValue);
            return true;
        }
        return false;
    }
